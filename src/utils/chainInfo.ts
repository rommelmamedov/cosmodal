 ...
 */
export type SimplifiedChainInfo = Omit<ChainInfo, 'stakeCurrency' | 'feeCurrencies'> & {
	currencies: Array<
		AppCurrency & {
...
export function createKeplrChainInfo({ currencies: _currencies, ...chainInfo }: SimplifiedChainInfo): ChainInfo {
...
export const getChainInfo = async (chainId: ChainInfo['chainId'], chainInfoOverrides?: ChainInfoOverrides) => {
