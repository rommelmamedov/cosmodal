...
export type SigningClientGetter<T> = (chainInfo: ChainInfo) => T | Promise<T | undefined> | undefined;

export type ChainInfoOverrides = ChainInfo[] | (() => undefined | ChainInfo[] | Promise<undefined | ChainInfo[]>);
...
export type UseWalletResponse = Partial<ConnectedWallet> & Pick<IWalletManagerContext, 'status' | 'connected' | 'error'>;

export type ConnectWalletToChainFunction = (chainId: ChainInfo['chainId']) => Promise<ConnectedWallet>;
