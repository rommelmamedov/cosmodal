...
export const CloseIcon: FunctionComponent<SVGProps<SVGSVGElement>> = props => (
	<svg fill="none" height={props.width || 16} viewBox="0 0 16 16" width={props.width || 16} xmlns="http://www.w3.org/2000/svg" {...props}>
		<path
			clipRule="evenodd"
