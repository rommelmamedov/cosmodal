import React, { FunctionComponent, PropsWithChildren, ReactElement, ReactNode, useEffect } from 'react';
...
export const BaseModal: FunctionComponent<BaseModalProps> = ({
	...
	return (
		...
		>
			<>
				{typeof title === 'string' ? <ModalHeader className={classNames?.modalHeader}>{title}</ModalHeader> : title}

				{onClose && (
					<ModalCloseButton className={classNames?.modalCloseButton} onClick={onClose}>
