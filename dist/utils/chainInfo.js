...
function createKeplrChainInfo(_a) {
    var { currencies: _currencies } = _a, chainInfo = tslib_1.__rest(_a, ["currencies"]);
    const currencies = [];
    const feeCurrencies = [];
    let stakeCurrency;
    for (const _currency of _currencies) {
        const currency = Object.assign(Object.assign({}, _currency), (_currency.coinImageUrl && {
    ...
    return Object.assign(Object.assign({}, chainInfo), { currencies,
        stakeCurrency,
        feeCurrencies });
}
...
const getChainInfo = (chainId, chainInfoOverrides) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const overrides = typeof chainInfoOverrides === 'function' ? yield chainInfoOverrides() : chainInfoOverrides;
    const chainInfo = 
