...
const WalletManagerProvider = ({ children, enabledWalletTypes, defaultChainId, chainInfoOverrides, classNames, closeIcon, renderLoader, walletConnectClientMeta, preselectedWalletType, localStorageKey, onKeplrKeystoreChangeEvent, getSigningCosmWasmClientOptions, getSigningStargateClientOptions, showEnablingModalOnAutoconnect = false, }) => {
    //! STATE
    ...
    return (react_1.default.createElement(WalletManagerContext_1.WalletManagerContext.Provider, { value: value },
        ...
        status !== types_1.WalletConnectionStatus.Resetting &&
            ...
            walletEnableModalOpen && (react_1.default.createElement(ui_1.EnablingWalletModal, { classNames: classNames, closeIcon: closeIcon, isOpen: true, onClose: () => setWalletEnableModalOpen(false), renderLoader: renderLoader, reset: _reset })),
